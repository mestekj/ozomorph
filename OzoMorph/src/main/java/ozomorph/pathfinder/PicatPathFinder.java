 ...
 */
public class PicatPathFinder implements PathFinder {
    private static final Logger logger = LoggerFactory.getLogger(PicatPathFinder.class);
    private final File picatModelFile;
    private final String picatRuntimePath;
     ...
     */
    public PicatPathFinder(String picatRuntimePath, File picatModelFile, GetPathCallback getPicatExec) {
        this.getPicatExec = getPicatExec;
        this.picatRuntimePath = (picatRuntimePath != null && !picatRuntimePath.isEmpty()) ? picatRuntimePath : "picat"; // if empty, search for picat using PATH
        this.picatModelFile = picatModelFile;
        this.name = picatModelFile.getName();
    }
     ...
     */
    @Override
    public List<AgentMapNode> findPaths(ProblemInstance problemInstance, ActionSettings actionSettings) throws IOException, InterruptedException, NoPlansFoundException {
        actionFactory = new ActionFactory(actionSettings);
        ...
        String picatOutput;
        try{
            picatOutput = runPicat(problemInstanceFile, picatRuntimePath);
    ...
    private String runPicat(File problemInstanceFile, String picatExecPath) throws IOException, InterruptedException, NoPlansFoundException {
        String picatMain = "../picat/solve.pi";

        ProcessBuilder builder = new ProcessBuilder(picatExecPath, picatMain, problemInstanceFile.getCanonicalPath(), picatModelFile.getCanonicalPath());
